...
import anonymous.evolution.repository.SPLRepository;
import anonymous.evolution.util.LogLevel;
...
import anonymous.evolution.variability.sequenceextraction.Domino;
...
import anonymous.simulation.shell.*;
...
import anonymous.simulation.diff.filter.EditFilter;
...
public abstract class Experiment {
    ...
    public Experiment(final ExperimentConfiguration config) {
        ...
        anonymous.evolution.Main.Initialize();
    ...
    /**
     * Get the difference between the target variant after patching and the target variant in the next anonymous.evolution step.
