...
import anonymous.simulation.diff.components.*;
import anonymous.simulation.diff.filter.DefaultLineFilter;
...
import anonymous.simulation.diff.lines.ContextLine;
import anonymous.simulation.diff.lines.Line;
import anonymous.simulation.diff.lines.RemovedLine;
import anonymous.simulation.diff.filter.DefaultFileDiffFilter;
