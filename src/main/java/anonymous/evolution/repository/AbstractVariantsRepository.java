package anonymous.evolution.repository;

import anonymous.evolution.variants.VariantCommit;
...
/**
 * Repository that mimics the anonymous.evolution of an ISPLRepository in terms of variants instead of an integrated code base.
 */
