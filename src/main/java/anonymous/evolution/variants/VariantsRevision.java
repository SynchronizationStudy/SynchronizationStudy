...
import anonymous.evolution.repository.AbstractVariantsRepository;
...
/**
 * Models a cut in the anonymous.evolution history of the IVariantsRevision.
 ...
 * A VariantsRevision runs and captures this co-anonymous.evolution for a single commit (i.e., modelled as a blueprint).
 */
public class VariantsRevision {
            ...
            final ListHeadTailView<VariantsRevisionBlueprint> remainingHistory)
    {
         ...
         * always generate the current variants before they can reason about the next revision (i.e., anonymous.evolution step).
     ...
     * @return The next anonymous.evolution step. Empty, when this was the last anonymous.evolution step.
     */
