...
import anonymous.evolution.variability.sequenceextraction.CleaningEvolutionStepsStream;
...
public class VariabilityDataset {
     ...
     *
     * <p>
     * The retrieved VariabilityHistory is a list that contains commit sequences that can be used for our anonymous.evolution study. Each
     ...
     * </p>
     *
     * @return All sequences of commits that are usable in our anonymous.evolution study.
     */
    ...
    /**
     * Collects all anonymous.evolution steps into a set.
     ...
     * </ul>
     *
     * @return Set of commit pairs that can be used in a variability anonymous.evolution study
     */
